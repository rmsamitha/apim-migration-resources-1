...
ALTER TABLE AM_KEY_MANAGER CHANGE TENANT_DOMAIN ORGANIZATION VARCHAR(100);
...
ALTER TABLE AM_BLOCK_CONDITIONS CHANGE VALUE BLOCK_CONDITION VARCHAR(512);
ALTER TABLE AM_APPLICATION_ATTRIBUTES CHANGE VALUE APP_ATTRIBUTE VARCHAR(1024);
